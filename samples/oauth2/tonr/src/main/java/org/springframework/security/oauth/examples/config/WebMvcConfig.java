...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    @Bean
    public SparklrRedirectController sparklrRedirectController(
            @Qualifier("sparklrRedirectService") SparklrService sparklrService) {
    ...
    public FacebookController facebookController(
            @Qualifier("facebookRestTemplate") RestOperations facebookRestTemplate) {
