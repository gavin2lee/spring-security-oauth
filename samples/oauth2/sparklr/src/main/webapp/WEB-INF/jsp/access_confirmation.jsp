...
<body>
	...
	<div class="container">
		...
		<%
			if (session.getAttribute("SPRING_SECURITY_LAST_EXCEPTION_KEY") != null
					&& !(session
							.getAttribute("SPRING_SECURITY_LAST_EXCEPTION_KEY") instanceof UnapprovedClientAuthenticationException)) {
		%>
		<div class="error">
			<h2>Woops!</h2>
